...
export default class BundleHistoryPropertiesDiffDialog extends React.Component {
  ...
  handleClickOpen = () => {
    ...
    new Promise((resolve, reject) => {
      let url = window.API + '/buckets/' + this.state.bucket.bucket_name + '/bundles/' + this.state.bundleId + '/history/properties/'
      if (previousId > 0)
