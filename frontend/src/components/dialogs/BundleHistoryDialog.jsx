...
import BundleHistoryPropertiesDiffDialog from './BundleHistoryPropertiesDiffDialog';
...
export default class BundleHistoryDialog extends React.Component {
  ...
  static getDerivedStateFromProps(props, state) {
    if (props.open === true) {
      ...
      let tagsLookup = {};
      for (var j = 0; j < props.tags.length; j++) {
      ...
      let preparedColumns = [
        ...
        },
        {
          ...
          render: rowData => <div>{rowData.properties != null ?
            <BundleHistoryPropertiesDiffDialog
              bucket={props.bucket}
    ...
    return (
      ...
      >
        <DialogTitle id="customized-dialog-title" onClose={this.handleClose}>
          Bundle history [bundle id: {this.state.bundleId}]
          </DialogTitle>
