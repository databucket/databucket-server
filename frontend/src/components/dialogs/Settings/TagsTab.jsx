                ...
                data={query =>
                    new Promise((resolve, reject) => {
                        ...
                        fetch(url)
                            ...
                            .then(result => {
                                this.props.onTagsLoaded(result.tags);
                                resolve({
                                    data: this.convertNullsToNoneOrEvery(result.tags),
                                    page: result.page - 1,
                ...
                editable={{
                    ...
                    onRowUpdate: (newData, oldData) =>
                        new Promise((resolve, reject) => {
                            ...
                            if (oldData.tag_name !== newData.tag_name) {
                                payload.tag_name = newData.tag_name;
                                changed = true;
