...
class BundleDetailsDialog extends React.Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      valid: true,
      columns: [
        { title: 'Bundle id', field: 'bundle_id', type: 'numeric' },
  ...
  static getDerivedStateFromProps(props, state) {
    return { bundle: props.bundle, open: props.open };
  }
  ...
  handleSave = () => {
    let changedBundle = this.state.bundle;
    changedBundle.properties = this.changedProperties;
    this.props.onChange(changedBundle, true);
    ...
    return (
      ...
      >
        ...
        <DialogContent>          
          <JSONInput
            id='json_editor'
            placeholder={this.state.bundle !== null ? this.state.bundle.properties : null}
...
export default withStyles(styles)(BundleDetailsDialog);
