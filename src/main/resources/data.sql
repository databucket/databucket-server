INSERT INTO columns (columns_id, columns_name, created_by, columns) VALUES (0, 'default columns', CURRENT_USER,
    '[
...
INSERT INTO views (view_id, view_name, columns_id, created_by) VALUES (0, 'default view', 0, CURRENT_USER) ON CONFLICT DO NOTHING;