package pl.databucket.old_service;
...
public class ServiceUtils {
    ...
    public boolean isBucketExist(String bucketName) throws UnknownColumnException, ConditionNotAllowedException {
    ...
    public boolean isViewExist(Integer viewId) throws UnknownColumnException, ConditionNotAllowedException {
        List<Condition> conditions = new ArrayList<>();
        conditions.add(new Condition(COL.VIEW_ID, Operator.equal, viewId));
        conditions.add(new Condition(COL.DELETED, Operator.equal, false));
    ...
    public boolean isGroupExist(Integer groupId, String groupName) throws UnknownColumnException, ConditionNotAllowedException {
        List<Condition> conditions = new ArrayList<>();
    ...
    public boolean isGroupExist(Integer groupId) throws UnknownColumnException, ConditionNotAllowedException {
        List<Condition> conditions = new ArrayList<>();
    ...
    public boolean isGroupExist(String groupName) throws UnknownColumnException, ConditionNotAllowedException {
        List<Condition> conditions = new ArrayList<>();
        conditions.add(new Condition(COL.GROUP_NAME, Operator.equal, groupName));
        conditions.add(new Condition(COL.DELETED, Operator.equal, false));
    ...
    public boolean isTagExist(Integer tagId) throws UnknownColumnException, ConditionNotAllowedException {
        List<Condition> conditions = new ArrayList<>();
    ...
    public boolean isTagExist(Integer tagId, String tagName) throws UnknownColumnException, ConditionNotAllowedException {
        List<Condition> conditions = new ArrayList<>();
        conditions.add(new Condition(COL.TAG_NAME, Operator.equal, tagName));
        conditions.add(new Condition(COL.DELETED, Operator.equal, false));
    ...
    public String getStringWithItemsNames(String itemType, List<Map<String, Object>> objects) {
    ...
    public void convertBucketsToArray(List<Map<String, Object>> source) throws UnexpectedException {
        try {
            ObjectMapper mapper = new ObjectMapper();
            for (Map<String, Object> itemMap : source) {
                String targetItemValueStr = (String) itemMap.get(COL.BUCKETS);
                if (targetItemValueStr != null) {
                    List<Integer> targetItemList = mapper.readValue(targetItemValueStr, new TypeReference<List<Integer>>() {
                    });
                    itemMap.put(COL.BUCKETS, targetItemList);
                }
            }
        } catch (Exception e) {
            throw new UnexpectedException(e);
