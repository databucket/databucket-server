...
public class DataController {
    ...
    public ResponseEntity<?> insertData(
            ...
            @ApiParam(value="payload - data", required = true)
    ...
    public ResponseEntity<?> insertMultiData(
            @ApiParam(value="bucket name", required = true)
            @PathVariable String bucketName,
            @ApiParam(value="payload - a list of data", required = true)
    ...
    public ResponseEntity<?> modifyData(
            @ApiParam(value="bucket name", required = true)
            @PathVariable String bucketName,
            @ApiParam(value="ids", example = "1,2,3", required = true)
            @PathVariable Optional<List<Long>> ids,
            @ApiParam(value="payload - data details (rules are ignored in this endpoint)", required = true)
    ...
    public ResponseEntity<?> modifyData(
            @ApiParam(value="bucket name", required = true)
            @PathVariable String bucketName,
            @ApiParam(value="payload - data details and rules", required = true)
            @RequestBody DataModifyDTO dataModifyDTO) {
    ...
    public ResponseEntity<?> getData(
            ...
            @ApiParam(value="limit", example = "1")
            @RequestParam(required = false, defaultValue = "1") Integer limit,
            @ApiParam(value="sort", example = "id")
            @RequestParam(required = false, defaultValue = "id") String sort,
            @ApiParam(value="payload - rules (required), columns (optional)", required = true)
    ...
    public ResponseEntity<?> reserveData(
            @ApiParam(value="bucket name", example = "bucket", required = true)
            @PathVariable String bucketName,
            @ApiParam(value="limit", example = "1")
            @RequestParam(required = false, defaultValue = "1") Integer limit,
            @ApiParam(value="sort", example = "random")
            @RequestParam(required = false, defaultValue = "id") String sort,
            @ApiParam(value="payload - rules (required)", required = true)
    ...
    public ResponseEntity<?> deleteData(
            @ApiParam(name = "bucket name", required = true)
            @PathVariable String bucketName,
            @ApiParam(value="payload - rules (required)", required = true)
