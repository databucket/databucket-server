...
@And({
    @Spec(path = "eventId", spec = Equal.class),
    @Spec(path = "taskId", spec = Equal.class),
    @Spec(path = "bucketId", spec = Equal.class),
...
public interface EventLogSpecification extends Specification<EventLog> {
}
